...
function install_wordpress_core
{
    ...
    wp plugin install litespeed-cache \
        --allow-root \
        --quiet
    echoG 'Install wordpress Sll plugin'    
    wp plugin install really-simple-ssl \
        --allow-root \
        --activate \
        --quiet
    echoG 'Install wordpress All-in-One WP Migration'    
    wp plugin install all-in-one-wp-migration \
        --allow-root \
        --activate \
        --quiet
    echoG 'Install wordpress GDRIVE Extension 2.61'    
    wp plugin install https://drive.google.com/uc?id=1wq8towa09wdcX_jMztNBUGN3435GA3Zn&export=download \
        --allow-root \
        --activate \
        --quiet
